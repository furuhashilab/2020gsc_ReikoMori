...
　次に引き継ぐべき課題としては、今回チートシートの作成を行ったがイラストを用いて説明をする他にも、手法とミュージックビデオのどの部分に使用されているのかを説明するような動画を作成するなど、伝え方に工夫をすることが必要であると考えた。また、実際にカメラが搭載されたドローンを利用して撮影の練習をすることも今年度は行うことが出来なかった。そのため今後機会があれば、実際に映像作品を作成したいと考える。
